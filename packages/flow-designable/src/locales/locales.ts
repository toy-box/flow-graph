      ...
      flow: {
        ...
        form: {
          ...
          decision: {
            ...
            operationTitle: '资源',
            removeResult: '删除结果',
            defaultConnectorName: '默认结果标签',
          },
          loop: {
            addTitle: '新增循环',
            editTitle: '编辑循环',
            setCollectionReference: '选择集合变量',
          ...
          httpCalls: {
            ...
            enumPath: 'REST参数',
            enumNoAuth: '无认证',
            enumBearerToken: 'Bearer Token鉴权',
            enumBasicAuth: 'Basic Auth鉴权',
            enumNone: 'none',
      ...
      flow: {
        ...
        form: {
          comm: {
            ...
            arrayTableType: 'Type',
            arrayTableKey: 'Key',
            arrayTableValue: 'Value',
            arrayTableName: 'Name',
            arrayTableOperations: 'Operations',
            arrayTableAdd: 'Add Item',
          },
          resourceCreate: {
          ...
          validator: {
            ...
            sortOrderIsEmpty: 'Sort Order is required',
          },
          placeholder: {
          ...
          decision: {
            ...
            defaultConnectorName: 'defaultName Label',
          },
          loop: {
            addTitle: 'New Loop',
            editTitle: 'Edit Loop',
          ...
          recordUpdate: {
            ...
            inputAssignments: 'Set Field Value',
            field: 'field',
            filterTitle: 'Update Record Filter Condition',
            addBtn: 'Add Filter',
          },
          recordLookUp: {
          ...
          httpCalls: {
            ...
            enumPath: 'Path',
            enumNoAuth: 'No Auth',
            enumBearerToken: 'Bearer Token',
            enumBasicAuth: 'Basic Auth',
            enumNone: 'none',
            enumFormData: 'form-data',
            enumFormUrl: 'x-www-form-urlencoded',
            json: 'json',
